    ...
    : window(sf::VideoMode({ 1920, 1080 }), "SFML window")
{
    ...
    this->buffer = new sf::SoundBuffer[3]{ sf::SoundBuffer("assets/Audio/sound1_2.wav"), sf::SoundBuffer("assets/Audio/sound2.wav"), sf::SoundBuffer("assets/Audio/sound5.ogg") };
